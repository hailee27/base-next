    ...
    <div className=" w-full min-h-screen h-full md:px-[100px] pc:px-0 relative ">
      <div className="absolute flex-col font-lexendDeca z-10 text-[#870608] w-full flex items-center  md:w-[80%] left-[50%] -translate-x-[50%]  h-full">
        <div className="w-full h-full flex items-center justify-between flex-col space-y-[80px]">
          ...
          >
            <span className="md:text-[28px] md:w-[500px] text-center" data-aos="fade-up">
            ...
            >
              <div className="md:text-[44px] text-[32px]  text-center font-medium " data-aos="fade-up">
                {router.pathname === '/nha-trai' ? 'TƯ GIA NHÀ TRAI' : 'TƯ GIA NHÀ GÁI'}
              </div>
              <div
                className="md:text-[24px] text-[16px] underline underline-offset-[7px] opacity-80 text-center"
                data-aos="fade-up"
              >
                {router.pathname === '/nha-trai'
            ...
            <div className="text-center w-full flex items-center justify-center" data-aos="fade-up">
              <Image alt="" src="/images/flower-decor-t2@3x.png" width={150} height={150} />
            </div>
            <div className="text-center text-[24px]" data-aos="fade-up">
              VÀO LÚC 17 GIỜ 30, THỨ SÁU
              <div className="md:text-[60px] text-[40px]" data-aos="fade-up">
                {' '}
                01 . 12 . 2022
              </div>
              <span className="xl:text-[32px] text-[16px]" data-aos="fade-up">
